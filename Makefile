...
export LDFLAGS=-ldflags "-X github.com/diannaowa/cri-template/version.Version=${VERSION} -X github.com/diannaowa/cri-template/version.PreRelease=${PRERELEASE} -X github.com/diannaowa/cri-template/version.BuildTime=${BUILD_DATE} -X github.com/diannaowa/cri-template/version.GitCommit=${REVISION}"
