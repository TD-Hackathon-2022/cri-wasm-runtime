...
func (ds *templateService) getSecurityOpts(
...
func (ds *templateService) getSandBoxSecurityOpts(separator rune) []string {
	logrus.Info("getSandBoxSecurityOpts is unsupported in this build")
	return nil
}

func (ds *templateService) updateCreateConfig(
...
func (ds *templateService) determinePodIPBySandboxID(uid string) []string {
...
func (ds *templateService) applyPlatformSpecificDockerConfig(
...
// after either the container creation has failed or the container has been removed.
func (ds *templateService) performPlatformSpecificContainerCleanup(
...
func (ds *templateService) platformSpecificContainerInitCleanup() (errors []error) {
	return
}

func (ds *templateService) performPlatformSpecificContainerForContainer(
	containerID string,
) (errors []error) {
...
func (ds *templateService) performPlatformSpecificContainerCleanupAndLogErrors(
